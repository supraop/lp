...
class PrimsMST {
	...
	// A utility function to print the constructed PrimsMST
	// stored in parent[]
	...
	// Function to construct and print PrimsMST for a graph
	...
	void primMST(int graph[][])
	{
		...
		for (int count = 0; count < V - 1; count++) {
			...
			// vertices not yet included in PrimsMST
			...
			// yet included in PrimsMST
			for (int v = 0; v < V; v++)

				// graph[u][v] is non zero only for adjacent
				// vertices of m mstSet[v] is false for
				// vertices not yet included in PrimsMST Update
		...
		// Print the constructed PrimsMST
